...

  {
    ...
    sm.def("loadModel",
           [](const DevicePtr_t& robot, const FrameIndex& baseFrame,
             ...
             urdf::loadModel(robot, baseFrame, prefix, rootType, urdfPath,
                             srdfPath, SE3::Identity());
           });
  }
}
}  // namespace pinocchio
...
void expose(py::module& m) {
  ...
  py::class_<TOPPRAPathWrapper, std::shared_ptr<TOPPRAPathWrapper>,
